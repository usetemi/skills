...
3. **When no sample is provided,** fall back to the default behavior (natural, varied, opinionated voice from `references/personality-and-soul.md`).
...
Read `references/personality-and-soul.md` for the full guidance on adding voice - signs of soulless writing, how to inject personality, and a before/after example showing the difference between "clean but soulless" and writing with a pulse.
...
Originally authored by Siqi Chen ([blader/humanizer](https://github.com/blader/humanizer)), MIT licensed. See `LICENSE`.
